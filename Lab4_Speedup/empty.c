...
// Same data set method as your Lab 3 Ex 2.2
static uint8_t myData[DATA_SIZE];

/* ===== DMA setup (from lab handout) ===== */
...
int main(void)
{
    ...
    /* Fill myData exactly like your Lab 3 Ex 2.2 */
    srand(12345);
    for (int i = 0; i < DATA_SIZE; i++) {
        myData[i] = rand();
    }

    /* CRC setup (same as your Lab 3 Ex 2.2) */
    DL_CRC_reset(CRC);
    ...
    /* Timer setup (same as your Lab 3 Ex 2.2) */
    ...
    /* DMA setup code (from lab handout) */
    ...
    /* Speedup of DMA over hardware = hardware_time / dma_time */
    if (dma_time_us != 0) {
